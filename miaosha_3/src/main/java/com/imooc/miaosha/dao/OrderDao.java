...
public interface OrderDao {
	...
	@Insert("insert into order_info(user_id, goods_id, goods_name, " +
			"goods_count, goods_price, order_channel, status, create_date)values("
	...
	@Insert("insert into miaosha_order (user_id, goods_id, " +
			"order_id)values(#{userId}, #{goodsId}, #{orderId})")
